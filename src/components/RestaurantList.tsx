    ...
    <>
      <TabGroup selectedIndex={selectedTab} onChange={setSelectedTab}>
        <TabList className="m-auto mx-4 mb-5 flex max-w-[1440px] items-center justify-center lg:mx-auto lg:max-w-[900px] xl:max-w-[1180px]">
          <Tab className="min-h-[53px] grow border-b pr-3 pb-1 pl-2 font-semibold text-gray-600 focus:not-data-focus:outline-none data-focus:text-blue-500 data-focus:outline-none data-focus-visible:outline-none data-selected:border-b-2 data-selected:text-blue-600">
            Все
          </Tab>

          <Tab className="min-h-[53px] grow border-b pr-2 pb-1 pl-3 font-semibold text-gray-600 focus:not-data-focus:outline-none data-focus:outline-none data-focus-visible:outline-none data-selected:border-b-2 data-selected:text-blue-600">
            Недавно заказывали
          </Tab>
